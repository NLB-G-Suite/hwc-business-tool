...
export class GoogleSheetService {
  ...
  public readCells(sheet, rows: number): Promise {
    return new Promise((resolve, reject) => {
      sheet.getCells({
        'min-row': 1,
        'max-row': rows,
   ...
   */
  public readRows(sheet, options?: any): Promise {
    return new Promise((resolve, reject) => {
  ...
  public getHeaders(sheet: any): Promise {
    return new Promise((resolve, reject) => {
      sheet.getCells({
        'max-row': 1,
        'return-empty': false
